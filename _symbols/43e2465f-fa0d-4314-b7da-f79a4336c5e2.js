...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "href", a_href_value = /*item*/ ctx[4].url);
			attr(a, "title", a_title_value = /*item*/ ctx[4].label);
			toggle_class(a, "current", checkCurrent(/*index*/ ctx[6]));
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*links*/ 2 && t_value !== (t_value = /*item*/ ctx[4].label + "")) set_data(t, t_value);

			if (dirty & /*links*/ 2 && a_href_value !== (a_href_value = /*item*/ ctx[4].url)) {
				attr(a, "href", a_href_value);
			}

			if (dirty & /*links*/ 2 && a_title_value !== (a_title_value = /*item*/ ctx[4].label)) {
...
function instance($$self, $$props, $$invalidate) {
	...
	return [email, links, props, title];
}

class Component extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { props: 2, email: 0, links: 1, title: 3 });
	}
}
